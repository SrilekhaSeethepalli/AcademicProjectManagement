...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-C6RzsynM9kWDrMNeT87bh95OGNyZPhcTNXj1NW7RuBCsyN/o0jlpcV8Qyq46cDfL" crossorigin="anonymous"></script>
  ...
  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profileDropdown">
    ...
    <div class="container mt-5">
        ...
        <div class="card mt-3">
            <div class="card-body">
                <h2 class="card-title">Flood Forecasting System</h2>
                <p class="card-text"><strong>Project ID:</strong>1001</p>
                <p class="card-text"><strong>Description:</strong> A Flood Forecasting System is a critical tool for predicting and monitoring potential flooding events. It utilizes real-time data from sources like weather stations and river gauges, along with advanced hydrological models, to simulate the impact of rainfall and weather conditions on river levels. By integrating weather forecasts, it provides early warning alerts to authorities and the public, enabling timely flood response and evacuation plans. These systems play a crucial role in minimizing flood-related risks, protecting lives, and mitigating economic losses through effective disaster preparedness and response.</p>
            </div>
        </div>
